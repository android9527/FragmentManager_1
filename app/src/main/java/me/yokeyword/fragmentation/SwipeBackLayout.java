...
import io.github.fragmentmanager.R;
...
//                    if (mPreFragment instanceof Fragment) {
//                        ((Fragment) mPreFragment).getSupportDelegate().mLockAnim = true;
//                    }
...
//                    }
//                    if (mPreFragment instanceof Fragment) {
//                        ((Fragment) mPreFragment).getSupportDelegate().mLockAnim = false;
//                    }
                } else {
